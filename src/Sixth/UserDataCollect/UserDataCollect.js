            ...
            <div id="form-collect">
                ...
                <div id="form-personal" className='mb-2'>
                 ...
                 <div id="form-personal" className='mb-2'>
                    <div className='d-flex align-items-center justify-content-between'>
                        ...
                        <Switch defaultChecked={true} onChange={() => (setCheckWork(!checkWork))} colorScheme='gray' />
                    </div>
                    <hr />
                ...
                <div id="form-personal" className='mb-2'>
                    <div className='d-flex align-items-center justify-content-between'>
                        ...
                        <Switch defaultChecked={true} onChange={() => (setCheckProj(!checkProj))} colorScheme='gray' />
                    </div>
                    <hr />
                ...
                <div id="form-personal" className='mb-2'>
                    <div className='d-flex align-items-center justify-content-between'>
                        ...
                        <Switch defaultChecked={true} onChange={() => (setCheckAward(!checkAward))} colorScheme='gray' />
                    </div>
                    <hr />
                    <FormControl isRequired className='my-2'>
