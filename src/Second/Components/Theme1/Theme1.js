...
const Theme1 = (props) => {
    ...
    const { name, profile, address, phone, email, skill,language } = themeData.personalData;
                                    ...
                                    Object.entries(extraSectionTitles).map((element, index) => {
                                        return (
                                            <Box key={index} className="mt-1">
                                                ...
                                                <Heading _dark={{ color: 'gray.800' }} bg={'#D2E4E1'} as='h3' size='md' px={20} py={2}>{element[1]}</Heading>
