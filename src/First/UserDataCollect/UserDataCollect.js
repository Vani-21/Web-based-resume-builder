        ...
        <>
            <div id="form-collect">
                ...
                <div id="form-personal" className='mb-2'>
                    ...
                    <FormControl isRequired className='my-2'>
                        <Input name='linkedin' onChange={handleChangePersonal} type={'email'} placeholder='LinkedIn id' />
                    </FormControl>
                </div>
