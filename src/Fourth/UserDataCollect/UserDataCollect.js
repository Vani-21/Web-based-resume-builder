...
const UserDataCollect = () => {
    ...
    const [personalData, setPersonalData] = useState({name: "Your Name", summary: 'Lorem ipsum dolor sit amet, consectetur adipiscing eli', address: "Address Line", phone: "Phone Number", email: "Email Address",linkedin: "Linkedin id", skill: 'Write, your, skills, here',language: 'list,the, known,languages' })
