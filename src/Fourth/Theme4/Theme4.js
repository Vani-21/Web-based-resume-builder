...
const Theme4 = (props) => {
    ...
    const { name,  address, phone, email,linkedin, skill,language } = themeData.personalData;
            ...
            <Box id="section-to-print" ref={componentRef}>
                <Box _dark={{ border: '1px solid white' }} id="theme1">
                    ...
                    <header id='info' className='text-center mt-2'>
                       ...
                       {/*<Heading as='h1' size='md' className='mt-1 mb-2'>
                            {profile}
                        </Heading>*/}
                        ...
                        {/* WORK EXPERIENCE  */}
                    {
                        ...
                        <section id="experience" className='my-2'>
                            <Heading _dark={{ color: '' }} bg={''} as='h3' size='md' px={10} py={2}>
                            WORK EXPERIENCE
                                    ...
                                    Object.entries(extraSectionTitles).map((element, index) => {
                                        return (
                                            <Box key={index} className="mt-1">
                                                ...
                                                <Heading _dark={{ color: '' }} bg={''} as='h3' size='md' px={10} py={2}>{element[1]}
                                                <div className="w-100 border border-dark m-auto"></div> 
                                                </Heading>
