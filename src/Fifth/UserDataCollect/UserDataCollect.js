...
const UserDataCollect = () => {
    ...
    const [personalData, setPersonalData] = useState({ profileImage: 'https://www.w3schools.com/howto/img_avatar.png', name: "Your Name", summary: 'Lorem ipsum dolor sit amet, consectetur adipiscing eli', profile: "Work Profile", address: "Address Line", phone: "Phone Number", email: "Email Address",linkedin:"LinkedIn id", skill: 'Write, your, skills, here',language: 'list,the, known,languages' })
