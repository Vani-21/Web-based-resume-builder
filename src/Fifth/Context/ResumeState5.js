...
const ResumeState5 = (props) => {
    ...
    const initialData = {
        ...
        extraSectionData: {
            extraSectionTitles: {exTitle1: "Extra Section"},
            extraSectionDesc: {exDescription1: "Extra Section Description"},
        },
    }
    ...
    const [checkExtraSectionData, setCheckExtraSectionData] = useState(false);
    ...
    return (
        <ResumeContext.Provider value={{ initialData, selectBtn, setSelectBtn, checkAward, setCheckAward, componentRef, handlePrint, currentTheme, setCurrentTheme, showComponent, setShowComponent, loading, setLoading, themeData, setThemeData, checkProj, checkWork, setCheckProj, setCheckWork,checkExtraSectionData,
