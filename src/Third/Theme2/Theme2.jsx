...
const Theme2 = (props) => {
    ...
    const { name, address, phone, email, profile, profileImage, summary, skill,language } = themeData.personalData;
        ...
        <Box id="section-to-print" ref={componentRef}>
            <Box id="theme2">
                <header id='info' className='text-center m-2 d-flex justify-content-between align-items-center'>
                    <Box className='info-text_1 text-start'>
                ...
                <section className='bottom-part d-flex mt-3'>
                    <section className='partition1'>
                        ...
                        <Box className='mt-5 '>
                            <Heading fontSize='2xl' className='my-2' >Languages</Heading>
                            <Box className='mt-3'>
                                {
                    ...
                    <div style={{ height: '960px' }} className="border border-dark mx-4"></div>
