...
const UserDataCollect = () => {
    ...
    const [personalData, setPersonalData] = useState({profileImage: 'https://www.w3schools.com/howto/img_avatar.png',profile: "Work Profile",name: "Your Name", summary: 'Lorem ipsum dolor sit amet, consectetur adipiscing eli', address: "Address Line", phone: "Phone Number", email: "Email Address",linkedin: "Linkedin id", skill: 'Write, your, skills, here',language: 'list,the, known,languages' })
        ...
        <>
            <div id="form-collect">
                ...
                <div id="form-personal" className='mb-2'>
                 ...
                 <div id="form-personal" className='mb-2'>
                    <div className='d-flex align-items-center justify-content-between'>
                        ...
                        <Switch defaultChecked={true} onChange={() => (setCheckWork(!checkWork))} colorScheme='blackAlpha' />
                    </div>
                    <hr />
                    <Button disabled={checkWork} onClick={handleWorkClick} className='my-3 w-100' colorScheme='blackAlpha' variant='solid'>Add Experience</Button>
                    {
                ...
                <div id="form-personal" className='mb-2'>
                    ...
                    <hr />
                    <Button onClick={handleEducationClick} className='my-3 w-100' colorScheme='blackAlpha' variant='solid'>Add Education</Button>
                    {
                ...
                <div id="form-personal" className='mb-2'>
                    <div className='d-flex align-items-center justify-content-between'>
                        ...
                        <Switch defaultChecked={true} onChange={() => (setCheckProj(!checkProj))} colorScheme='blackAlpha' />
                    </div>
                    <hr />
                    <Button disabled={checkProj} onClick={handleProjectClick} className='my-3 w-100' colorScheme='blackAlpha' variant='solid'>Add Projects</Button>
                    {
                ...
                <div id="form-personal" className='mb-2'>
                    <div className='d-flex align-items-center justify-content-between'>
                        ...
                        <Switch defaultChecked={true} onChange={() => (setCheckAward(!checkAward))} colorScheme='blackAlpha' />
                    </div>
                    <hr />
                    <FormControl isRequired className='my-2'>
                  ...
                  <div id="form-personal" className='mb-2'>
                    ...
                    <Button disabled={checkExtraSectionData} onClick={handleChangeExtraSectionDataClick}
                            className='my-3 w-100' colorScheme='blackAlpha'
