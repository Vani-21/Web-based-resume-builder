...
const BuilderArea = (props) => {
    ...
    return (
        <>
            {loading && <PropagateLoader id='spinner' color="#006DB2" size={30} />}
            ...
            <div className="d-flex flex-wrap justify-content-center">
                <Button className='mx-2 my-5'  variant={'solid'} borderColor={'#006DB2'} borderWidth={'3px'} onClick={handlePrint}>Print</Button>
